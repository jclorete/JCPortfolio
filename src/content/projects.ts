...
export const projectCategories: Record<string, ProjectCategory> = {
  ...
  short_form: {
    ...
    items: [
      ...
      { id: "sf-05", title: "Short-form Reel 05", drive_id: "1gNYmU8tkGDF-HL7qGK0uiOGsy4Rzp10o" },
      { id: "sf-06", title: "Short-form Reel 06", drive_id: "1ZjTcMGbPYcTuTzIvncNuwag0_lPyY5s1" },
